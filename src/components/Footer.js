                ...
                <Row className='my-3' md={3} lg={3} >
                    ...
                    className='img-fluid logo footer-logo'
                        ...
                        <div className='footer-content-main'>
                            <p>
                            When your business needs a website design and digital marketing partner, they need the best. I am here to help your business get noticed online by offering user-friendly web design and optimized digital marketing.
                            </p>
                        </div>
                    </Col>
