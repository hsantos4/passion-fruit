        ...
        <Container fluid="sm"> 
            <Row className='grid-row align-items-center' md={2} lg={2}>
                ...
                <Col className='text-center mission-vision-content' sm={12}>
                    <h3>Our Msison</h3>
                    <p> Our goal is to help you reach your professional goals and bring value to your business. On a mission to provide professional design, development and digital marketing services that help agency grow.</p>
