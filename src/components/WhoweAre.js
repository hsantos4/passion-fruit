...
const WhoweAre = () => {
    return (
        <Container className='mission-vision p-4 mt-4' fluid="sm"> 
            ...
            <Row className='align-items-center' md={2} lg={2}>
                ...
                <Col className='about-me-who-we-are' sm={12} md={ {order:1} }>
                    <h3>What I do</h3>
                    <p>I provide speacialized services to get insurance agency more awareness, leads and more cleints.</p>
                    < br/>
                    <p>I do this by offering insurance agencies high quality web products that produce results.</p>
                    <br />
