...
import AboutwhoWeare from '../components/WhoweAre';
import Missionvision from '../components/Missionvision';

import '../components/sass/page/about.scss';
...
const About = () => {
  return(
    <Container fluid  className='about-container'>
       <Helmet>
        <title>Passion Fruit Media Clt | About us</title>
        <meta name="description" content="On this page you will find information about Passion Fruit Clt and what we believe in" />
      </Helmet>
      ...
      {/* Benefits of choosing HS Digital Development */}
    
        <div className='about-benfits-heading'>The Benefits of our services</div>
      <Row sm={4} md={4} fluid className='about-benefits '>

        <Col className='about-benefits-container' sm={12} >
      ...
      <p>Trustworthy</p>
        ...
        <Col className='about-benefits-container' sm={12} >
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-columns" viewBox="0 0 16 16">
