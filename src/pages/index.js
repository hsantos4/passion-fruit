...
const HomePage = () => {
  return(
    <main>
      <Helmet>
        <title>Passion Fruit Media Clt | Helping your insurance agency reach the online audience.</title>
        <meta name="description" content="Offering business web services to reach the online audience"/>
      </Helmet>
